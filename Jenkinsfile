    ...
    stages {
        ...
        stage('Run Tests') {
            steps {
                ...
                dir(r"C:\Users\ChanikyaN-3227\PycharmProjects\MyProject Root Folder\Framework\TestCycles\Module 1") {
                ...
                dir(r"C:\Users\ChanikyaN-3227\PycharmProjects\MyProject Root Folder\Framework\TestCycles\Module 2") {
                    // Run Robot Framework tests for login module 1
                    bat 'TestCase_For_Login.robot'
                }
                // Navigate to the directory for module 2 tests
                dir(r"C:\Users\ChanikyaN-3227\PycharmProjects\MyProject Root Folder\Framework\TestCycles\Module 3") {
                    // Run Robot Framework tests for reg module 2
                    bat 'TestCase_For_HR-OS.robot'
                }
                // Then, navigate to the directory for module 2 tests
                dir(r"C:\Users\ChanikyaN-3227\PycharmProjects\MyProject Root Folder\Framework\TestCycles\Module 4") {
